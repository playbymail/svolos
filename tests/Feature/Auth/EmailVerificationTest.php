...
test('an unverified user is blocked from the dashboard', function () {
...
test('an unverified user is blocked from every verified-only route', function (string $method, string $route) {
    $user = User::factory()->unverified()->create();
